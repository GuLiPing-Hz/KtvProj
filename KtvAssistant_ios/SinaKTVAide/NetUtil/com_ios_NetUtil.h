...
#define IOSEXPORT extern "C"
    ...
    IOSEXPORT int IdPassAuth(const char* id,const char* passwd,int again);
    ...
    */
    ...
    /*
     ...
     @return : -1 失败，0成功
     */
    IOSEXPORT int RequestSendHB(char hbtype, int number, int gold, const char* mark, int extradata);
    ...
    /*
     ...
     @return : -1失败；0成功
     */
    IOSEXPORT int RequestHBStatus(const char* hbid);
    /*
     请求抢红包
     @param hbid : 红包ID
     ...
     @return : -1 失败，0成功
     */
    IOSEXPORT int RequestVieHB(const char* hbid);
    ...
    /*
     ...
     @return : -1 失败，0成功
     */
    IOSEXPORT int RequestHBDetail(const char* hbid);
    ...
    /*
     ...
     @return : -1失败；0成功
     */
    IOSEXPORT int RequestCurrentRoomHB(int roomid);
#ifdef __cplusplus
}
#endif
