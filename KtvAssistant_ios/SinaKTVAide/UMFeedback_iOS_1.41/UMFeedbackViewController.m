...
- (void)setModalStyle {
    ...
    UINavigationItem *item = [[UINavigationItem alloc] initWithTitle:UM_Local(@"用户反馈")];
    
    [bar setItems:@[item]];
    item.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:UM_Local(@"关闭")
...
{
    [super viewDidLoad];
    self.navBar.barTintColor = UIColorFromRGB(0xe4397d);
...
- (UIView *)infoView {
    if (_infoView == nil) {
        ...
        [infoButton setTitle:UM_Local(@"完善联系信息") forState:UIControlStateNormal];
