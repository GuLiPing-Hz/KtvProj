...
CGLSprite::CGLSprite(HTEXTURE texture, float texx, float texy, float w, float h)
{
...
void CGLSprite::Render(float x, float y)
{
...
void CGLSprite::RenderEx(float x, float y, float rot, float hscale, float vscale)
{
...
void CGLSprite::RenderStretch(float x1, float y1, float x2, float y2)
{
...
void CGLSprite::Render4V(float x0, float y0, float x1, float y1, float x2, float y2, float x3, float y3)
{
...
void CGLSprite::SetFlip(bool bX, bool bY, bool bHotSpot)
{
	float tx, ty;
...
void CGLSprite::SetTexture(HTEXTURE tex)
{
	float tx1,ty1,tx2,ty2;
	float tw,th;
...
void CGLSprite::SetTextureRect(float x, float y, float w, float h, bool adjSize)
{
	float tx1, ty1, tx2, ty2;
	bool bX,bY,bHS;
...
#include <stdio.h>
void CGLSprite::SetColor(DWORD col, int i)
{
	char buf[260] = {0};
	sprintf(buf,"color : %x\n",col);
