...
#include "../include/NetUtil/ResponseBase.h"
...
{
private:
    id m_callbackprotocol;
    
    CResponse():m_bRequestUpdateGroupRoomlist(false),m_nGroupVersionID(0)
        ,m_nTempCur(0),m_nTempCount(0){}
    virtual ~CResponse(){};
public:
    
    static CResponse* getResponseSingleton(){static CResponse s_response;return &s_response;}
