...
/**
 * @author 宋静
 * @version 创建时间：2013-12-5 下午3:52:45
 * 类说明 取消收藏
 */
public class DeleteCollectSongTask extends AsyncTask<Void, Void, String> {
	...
	public DeleteCollectSongTask(Handler handler, long userId, int song) {
		super();
	...
	public String getUrl() {
		...
		String baseUrl = KtvAssistantAPIConfig.KtvAssistantAPIDomain
				+ KtvAssistantAPIConfig.APIUrl.DeleteCollectSong;
	...
	protected void onPostExecute(String result) {
		...
		msg.what = MessageDef.WM_DELETE_COLLECT_SONG;// command
