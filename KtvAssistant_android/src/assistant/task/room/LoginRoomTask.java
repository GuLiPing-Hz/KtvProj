...
/**
 * 利用房间密钥登录,二维码内容，或手动输入编码
 * 
 * @author pig
 * 
 */
@Deprecated
public class LoginRoomTask extends AsyncTask<Void, Void, String> {

	private Handler handler;
	private String password;
	private long userId;

	public LoginRoomTask(Handler handler, String password, long userId) {
		super();
	...
	public String getLoginUrl(String tPassword) {
		String baseUrl = KtvAssistantAPIConfig.KtvAssistantAPIDomain
				+ KtvAssistantAPIConfig.APIUrl.RoomLogin;
		String param ="?roompassword="+tPassword+"&userId="+ userId;
