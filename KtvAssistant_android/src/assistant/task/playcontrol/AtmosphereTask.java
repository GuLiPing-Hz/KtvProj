...
public class AtmosphereTask extends AsyncTask<Void, Integer, String> {

	Handler m_handler;
	int 		  m_atmosphere;//1：喝彩，2鼓掌
	public AtmosphereTask(Handler m_handler){
		super();
	}
	public void setArgu(int atmosphere) {
	...
	String getUrl(){
		...
		String baseUrl = KtvAssistantAPIConfig.KtvAssistantAPIDomain
				+ KtvAssistantAPIConfig.APIUrl.Atmosphere;
		String param = "?ktvid=" + AppStatus.ktvId + "&roomid=" + AppStatus.roomId + "&roompassword=" 
				+ AppStatus.room_password+ "&amtosphere="+ m_atmosphere;
	...
	protected void onPostExecute(String result) {
		...
		msg.what = (0 == nStatus) ? errorcode : MessageDef.HTTP_ATMOSPHERE;// command
