...
public class SingModeTask extends AsyncTask<Void, Integer, String> {

	Handler m_handler;
	
	public SingModeTask(Handler m_handler) {
		super();
	...
	String getUrl(){
		...
		String baseUrl = KtvAssistantAPIConfig.KtvAssistantAPIDomain
				+ KtvAssistantAPIConfig.APIUrl.SingMode;
		String param = "?ktvid=" + AppStatus.ktvId + "&roomid=" + AppStatus.roomId + "&roompassword=" 
				+ AppStatus.room_password+ "&singmode=0";
	...
	protected void onPostExecute(String result) {
		...
		msg.what = (0 == nStatus) ? errorcode : MessageDef.HTTP_SING_MODE;// command
