...
public class MuteOOTask extends AsyncTask<Void, Integer, String> {

	Handler m_handler;
	
	public MuteOOTask(Handler m_handler) {
		super();
	...
	protected void onPostExecute(String result) {
		...
		msg.what = (0 == nStatus) ? errorcode : MessageDef.HTTP_MUTE_OO;// command
