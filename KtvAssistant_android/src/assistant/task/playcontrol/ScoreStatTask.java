...
public class ScoreStatTask extends AsyncTask<Void, Integer, String> {
	Handler m_handler;
	
	public ScoreStatTask(Handler m_handler) {
		super();
	...
	String getUrl(){
		...
		String baseUrl = KtvAssistantAPIConfig.KtvAssistantAPIDomain
				+ KtvAssistantAPIConfig.APIUrl.ScoreState;
		String param = "?ktvid=" + AppStatus.ktvId + "&roomid=" + AppStatus.roomId + "&roompassword=" 
				+ AppStatus.room_password+ "&scoremode=0";
	...
	protected void onPostExecute(String result) {
		...
		msg.what = (0 == nStatus) ? errorcode : MessageDef.HTTP_SCORE_STAT;// command
