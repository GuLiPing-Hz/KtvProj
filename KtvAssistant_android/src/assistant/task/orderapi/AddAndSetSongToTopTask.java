...
public class AddAndSetSongToTopTask extends AsyncTask<Void, String, String> {
	...
	public AddAndSetSongToTopTask(Handler tHandler, String tKtvId,
			String tRoomId, String tPassword, SongInfo song) {
	...
	protected String getAddAndSetSongToTopUrl(String tKtvId, String tRoomId,
		...
		String baseUrl = KtvAssistantAPIConfig.KtvAssistantAPIDomain
				+ KtvAssistantAPIConfig.APIUrl.SongAddAndSetSongToTop;
	...
	protected String doInBackground(Void... params) {
		...
		requestUrl = getAddAndSetSongToTopUrl(ktvid, roomid, password,
				song.songId, song.songName, song.songArtist, song.songIsScore);
	...
	protected void onPostExecute(String result) {
		...
		try {
			...
			if (null != jsonObject) {
				ShowLog.i("AddAndSetSongToTopTask result: "
						+ jsonObject.toString());
		...
		msg.what = MessageDef.WM_ADD_AND_SET_SONG_TO_TOP;// command
