	...
	*/
	...
	//手机ktv聊天信息
		...
		*/
		 ...
		 */
		void RecvNotifyMessage(int msgId,String msgContent);
	    //单个礼物图片下载完成通知
		...
		*/
		void RecvUserIdxAndType(ResultData_UIdxWithType[] list);
		...
		*/
		void RecvUserLoginLobbyNoticeNew(int idx,byte type);
		...
		*/
		void RecvHongBao(int idx,String hbid,byte hbtype,String remark);
		 ...
		 */
		void RecvHongBaoStatus(String hbid,int ret);
		/*
		抢红包的结
		@param result : 抢红包的结果: 0-没抢到  1-抢到 9999-服务器相应超时 OPTION_TIMEOUT
		@param idx : 发红包用户的IDX
		@param bhid : 红包ID
		@param hbtype : 红包类型
		@param remark : 红包备注
		...
		*/
		void RecvVieHongBaoResult(int result,int idx,String hbid,byte hbtype,String remark,int gold);
		...
		@param num : list列表的数量
		*/
		void RecvHongBaoDetail(int ret,int idx,byte hbtype,String remark,int totalgold,int totalnum
		...
		@param score : 分数
		*/
		void RecvSingSongChange(String songname,String singername,int score);

		/*
		通知红包数量更新
		@param number : 可领取的红包数量
		*/
		void RecvHongBaoNum(int number);
		...
		@param list : 红包列表
		*/
		void RecvRoomHB(int ret,ResultData_RoomHB[] list);
	    /*
