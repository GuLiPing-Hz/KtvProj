...
public class SlidingActivityHelper {
	 ...
	 */
	public SlidingActivityHelper(FragmentActivity activity) {
		mActivity = activity;
	}
	...
	public void onCreate(Bundle savedInstanceState) {
		View v = LayoutInflater.from(mActivity).inflate(R.layout.sm_main, null);;
		mSlidingMenu = (SlidingMenu)v;
	}
	...
	/**
	 * Set the behind secondary view content to an explicit view. This view is placed directly into the behind view 's view hierarchy.
	 * It can itself be a complex view hierarchy.
	 *
	 * @param view The desired content to display.
	 * @param layoutParams Layout parameters for the view. (unused)
	 * @throws Exception 
	 */
	public void setSecondaryContentView(View view) throws Exception {
		if(mViewBehind == null)
	...
	public boolean onKeyUp(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK && mSlidingMenu.isContentShowing()) {
			showMenu();
			return true;
		}
		return false;
	...
	public boolean isContentShowing(){
		return mSlidingMenu.isContentShowing();
	}
	...
	public void addIgnoredAboveView(View v) {
		mSlidingMenu.addIgnoredAboveView(v);
	}
	...
	public void removeIgnoredAboveView(View v) {
		mSlidingMenu.removeIgnoredAboveView(v);
	}
	...
	public void clearIgnoredAboveViews() {
		mSlidingMenu.clearIgnoredAboveViews();
	}
	...
	public void setOnLeftOpenListener(OnOpenListener listener) {
		mSlidingMenu.setOnLeftOpenListener(listener);
	}
	...
	public void setOnCloseListener(OnCloseListener listener) {
		mSlidingMenu.setOnCloseListener(listener);
	}
}
