...
import com.sliding.SlidingMenu.OnClosedListener;
import com.sliding.SlidingMenu.OnOpenedListener;
...
public class CustomViewAbove extends ViewGroup {
	...
	private boolean isInIgnoredView(MotionEvent ev) {
		...
		for (View v : mIgnoredViews) {
			...
			if (rect.contains((int)ev.getRawX(), (int)ev.getRawY())) return true;
		}
		return false;
	}
...
//				MyLog.i(TAG, "onInterceptTouchEvent MotionEvent.ACTION_DOWN thisTouchAllowed");
...
//				MyLog.d(TAG, "onInterceptTouchEvent MotionEvent.ACTION_DOWN thisTouch not Allowed ");
